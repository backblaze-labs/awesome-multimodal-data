...
- **[Aria-UI Data](https://huggingface.co/datasets/Aria-UI/Aria-UI_Data)** – 4.2M GUI grounding instruction-image pairs across web (173K images), mobile (104K), and desktop (7.8K) interfaces. Covers versatile and context-aware element grounding for GUI agent training. Apache-2.0. [Docs](https://github.com/AriaUI/Aria-UI)
...
- **[FineVision](https://huggingface.co/datasets/HuggingFaceM4/FineVision)** – 24M-sample multimodal instruction-tuning corpus from 200+ sources unified into 185 subsets. Covers general VQA, OCR, chart and table reasoning, science, captioning, grounding, and GUI tasks. Decontaminated against 66 public benchmarks. CC-BY-4.0. [Docs](https://arxiv.org/abs/2510.17269)
...
- **[LLaVA-OneVision-Data](https://huggingface.co/datasets/lmms-lab/LLaVA-OneVision-Data)** – 3.9M multimodal instruction-tuning samples across 89 subsets (VQA, OCR, math reasoning, captioning). Training data for the LLaVA-OneVision model family. Apache-2.0. [Docs](https://llava-vl.github.io/blog/2024-08-05-llava-onevision/)
- **[Multimodal Textbook](https://huggingface.co/datasets/DAMO-NLP-SG/multimodal_textbook)** – 6.5M keyframes interleaved with 0.8B ASR/OCR tokens from 75K instructional videos (22K class hours). Knowledge-rich pretraining corpus covering math, physics, chemistry. ICCV 2025 Highlight. Apache-2.0. [Docs](https://github.com/DAMO-NLP-SG/multimodal_textbook)
...
- **[PangeaInstruct](https://huggingface.co/datasets/neulab/PangeaInstruct)** – 6.45M multilingual multimodal instruction-tuning samples spanning 39 languages and 29 source datasets. Covers VQA, OCR, captioning, and cultural tasks. Training data for the Pangea-7B MLLM. Apache-2.0. [Docs](https://github.com/neulab/Pangea)
...
- **[ShareGPT4V](https://huggingface.co/datasets/Lin-Chen/ShareGPT4V)** – 1.2M high-detail image captions generated by GPT-4 Vision (100K) and a trained ShareCaptioner (1.1M). Long, world-knowledge-rich descriptions used for VLM pretraining and SFT. ECCV 2024. CC-BY-NC-4.0. [Docs](https://github.com/ShareGPT4Omni/ShareGPT4V)
- **[TextAtlas5M](https://huggingface.co/datasets/CSU-JPG/TextAtlas5M)** – 5.4M image-text pairs for dense text image generation, spanning synthetic and real-world text-rich images (slides, book covers, papers, styled text). Benchmark included. MIT. [Docs](https://github.com/CSU-JPG/TextAtlas)
- **[The Cauldron](https://huggingface.co/datasets/HuggingFaceM4/the_cauldron)** – 50 curated vision-language datasets in a unified instruction-tuning format, covering VQA, OCR, chart/table reasoning, and screenshot-to-code. 7.8M QA pairs, 2.3M images. Training data for IDEFICS2 and SmolVLM. CC-BY-4.0 prompts.
- **[WAON](https://huggingface.co/datasets/llm-jp/WAON)** – 155M Japanese image-text pairs from Common Crawl, filtered with SigLIP scores and pHash deduplication. Largest Japanese VLM pretraining corpus; improves Japanese cultural benchmarks. Apache-2.0 (Japanese copyright law "information analysis" use). [Docs](https://github.com/llm-jp/WAON)
...
- **[FineVideo](https://huggingface.co/datasets/HuggingFaceFV/finevideo)** – 43,751 CC-BY YouTube videos (3,425 hours) across 122 categories with rich per-scene annotations including mood, narrative, speech transcripts, and QA pairs. Used to train SmolVLM and InternVL. CC-BY. [Docs](https://huggingface.co/blog/fine-video)
...
- **[ViMix-14M](https://huggingface.co/datasets/TimingYang/ViMix-14M)** – 14M crawl-free, download-ready video-text pairs from merged open sources, with multi-granularity captions (brief, finer, detailed). Validated on retrieval, text-to-video generation, and VQA tasks. Apache-2.0. [Docs](https://arxiv.org/abs/2511.18382)
...
- **[DAVE](https://huggingface.co/datasets/gorjanradevski/dave)** – Diagnostic benchmark for audio-visual evaluation with 2,426 samples from EPIC-KITCHENS and Ego4D. Requires both modalities to answer; covers 7 task types including temporal ordering and audio-visual alignment. NeurIPS 2025. MIT. [Docs](https://github.com/gorjanradevski/dave)
...
- **[MuAViC](https://github.com/facebookresearch/muavic)** – 1,200-hour multilingual audio-visual corpus from TED/TEDx talks in 9 languages with transcriptions and speech-to-text translation labels. First open benchmark for audio-visual speech translation. CC-BY-NC-4.0. [Docs](https://ai.meta.com/blog/muavic-audio-visual-speech-translation-benchmark/)
...
- **[Docling](https://github.com/docling-project/docling)** – Document-to-AI-format conversion pipeline supporting PDF, DOCX, PPTX, images, and audio. Extracts layout, tables, charts, and text into Markdown/JSON for multimodal training pipelines. MIT. [Docs](https://docling-project.github.io/docling/) | SDK: Python (pip install docling)
...
- **[jina-embeddings-v4](https://huggingface.co/jinaai/jina-embeddings-v4)** – 3.8B-parameter multimodal embedding model for text, images, and visual documents (charts, tables). Supports dense and late-interaction retrieval across 30+ languages. Non-commercial (Qwen Research License). [Docs](https://jina.ai/news/jina-embeddings-v4-universal-embeddings-for-multimodal-multilingual-retrieval/) | SDK: Python (pip install transformers)
...
- **[vdr-multilingual-train](https://huggingface.co/datasets/llamaindex/vdr-multilingual-train)** – 500K multilingual query-image pairs collected from public internet PDFs with VLM-generated queries. Training set for visual document retrieval models; spans English, German, French, Spanish, and Italian. Apache-2.0. [Docs](https://huggingface.co/blog/vdr-2b-multilingual)
